export const abi = [
  ...
  {
    inputs: [{ internalType: "uint256", name: "big_price", type: "uint256" }],
    name: "setBigPrice",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
  ...
  {
    inputs: [{ internalType: "uint256", name: "small_price", type: "uint256" }],
    name: "setSmallPrice",
    outputs: [],
    stateMutability: "nonpayable",
    type: "function",
...
export const address = "0x3C9dB40bE3D7fec3B4920Ce33f1aDD6d313e9274";
